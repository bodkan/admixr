...
#'     on page 128).
#' @param config_prefix Prefix of "left" and "right" population files.
#'
#' @export
create_qpAdm_pop_files <- function(L, R, config_prefix) {
    writeLines(L, con=paste0(config_prefix, "__left"))
    writeLines(R, con=paste0(config_prefix, "__right"))
}
