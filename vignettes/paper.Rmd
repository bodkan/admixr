...
library(admixr)
path_to_eigenstrat <- download_data()
```
# admixr - R package for facilitating ADMIXTOOLS analyses
...
individual analysis, often using a combination of shell scripting and manual
...
* Filtering out potential ancient DNA damage substitutions &mdash; `filter_damage()`.
