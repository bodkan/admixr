...
qpAdm model fitting is a complex topic. Navigating it successfuly
...
_admixr_ and also talked about some important resources for learning
more the method pioneered by Iosif Lazaridis in
...
# install `devtools` if not on already your system by running:
# install.packages("devtools")
# this will allow installing 'admixr' from Github
#devtools::install_github("bodkan/admixr", ref = "qpadm-rotation", force = TRUE)
library(admixr)
