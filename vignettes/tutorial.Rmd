...
result <- f3(A = pops, B = pops, C = "Khomani_San", prefix = eigenstrat_prefix)
```
...
cat(system(paste0("column -t ", paste0(ind_path, ".merged_pops")), intern = TRUE), sep = "\n")
```
...
result <- d(W = "European", X = "African", Y = "Archaic", Z = "Chimp",
            prefix = eigenstrat_prefix, ind_suffix = ".merged_pops")
```
