...
# ERROR: dependencies ‘MASS’, ‘mgcv’ are not available for package ‘ggplot2’checking for hidden files and directories
# https://github.com/rstudio/packrat/issues/484#issuecomment-405621083
options(repos = c(CRAN = "https://cran.rstudio.com"))
ap <- available.packages()
install.packages(rownames(ap[ap[, "Priority"] %in% "recommended", ]))
```
