...
```{r qpAdm}
result <- qpAdm(
  target = c("French", "Sardinian"),
  references = c("Vindija", "Mbuti"),
...
```{r}
# rank 0
qpWave(left = c("French", "Sardinian", "Han"),
       right = c("Dinka", "Altai", "Denisova", "Yoruba", "Mbuti"),
       data = snp_data)
```

```{r}
# rank 1
qpWave(left = c("Papuan", "French", "Sardinian", "Han"),
       right = c("Dinka", "Altai", "Denisova", "Yoruba", "Mbuti"),
       data = snp_data)
```
