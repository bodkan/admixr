...
# _admixr_: an R interface for the ADMIXTOOLS software
...
will join an [excellent company](https://scholar.google.com/scholar?cites=13286994334855947290)
of papers which have used it to do amazing research. 🙂

> Petr Martin; Vernot Benjamin; Kelso Janet. _admixr_&mdash;R package for reproducible analyses using ADMIXTOOLS. Bioinformatics, Volume 35, Issue 17 (2019), pages 3194–3195. doi: 10.1093/bioinformatics/btz030.
...
This is all the code that you need to compute a $D$ statistic using ADMIXTOOLS
and the _admixr_ package! No shell scripting, no copy-pasting and manual editing of text files.
...
[tutorial vignette](https://bodkan.net/admixr/articles/vignette-01-tutorial.html).
